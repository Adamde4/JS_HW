...
function area_rectangle (side_a, side_b){
...
function area_cylinder (radius, high){
...
function ul_li_no_limit(text, number){
    document.write("<ul>")
...
function Array_ul_li_creator(array_primitives){
    document.write(`<ul>`)
...
function array_object_block_writer(array){
...
function array_min_value(numbers){
    let number = 0
